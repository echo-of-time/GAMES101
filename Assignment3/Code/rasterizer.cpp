...
{
    // TODO: From your Assignment2, get the triangle rasterization code.
    ...
    x_min = mymin(v[0].x(), v[1].x(), v[2].x());
    x_max = mymax(v[0].x(), v[1].x(), v[2].x());
    y_min = mymin(v[0].y(), v[1].y(), v[2].y());
    y_max = mymax(v[0].y(), v[1].y(), v[2].y());
